...
while True:
    ...
    # ключевым словам подгоняем готовые ответы. Даем возможность закончить диалог в любой момент
    ...
    if 'привіт' in text or 'хай' in text or 'доброго дня' in text:
        ...
        print(
            'Соррі, що втручаюсь, не знаю про що йдеться мова, але подивіться серіал "Паперовий будинок", він просто бомба!')
